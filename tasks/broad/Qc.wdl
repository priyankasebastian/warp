...
task CollectQualityYieldMetrics {
  ...
  command {
    java -Xms2000m -Xmx3400m -jar ${tool_path}/picard.jar \
...
task CollectUnsortedReadgroupBamQualityMetrics {
  ...
  command {
    java -Xms5000m -Xmx6900m -jar ${tool_path}/picard.jar \
...
task CollectWgsMetrics {
  ...
  command {
    java -Xms2000m -Xmx3g -jar ${tool_path}/picard.jar \
      CollectWgsMetrics \
      INPUT=~{input_bam} \
...
task CalculateReadGroupChecksum {
  ...
  command {
    java -Xms1000m -Xmx1900m -jar ${tool_path}/picard.jar \
...
task ValidateVCF {
  ...
  command {
    ${tool_path}/gatk/gatk --java-options "-Xms6000m -Xmx6900m" \
      ValidateVariants \
      -V ~{input_vcf} \
      -R ~{ref_fasta} \
...
task CollectVariantCallingMetrics {
  ...
  command {
    java -Xms2000m -Xmx2900m -jar ${tool_path}/picard.jar \
